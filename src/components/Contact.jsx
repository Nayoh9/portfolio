      ...
      <div className=" flex flex-wrap justify-center gap-28 max-[1125px]:flex-col max-[1125px]:items-center ">
        <a href="https://www.linkedin.com/in/yohann-andr%C3%A9/" target="blank">
          <motion.div
            ...
            viewport={{ once: true }}
            className=" flex h-contactBoxHeight w-80 flex-1 flex-col items-center rounded-md bg-lightGrey p-10  hover:border-solid dark:bg-gray-900  max-[1125px]:w-contactBoxWidth max-[600px]:w-80"
          >
        ...
        <a href="https://github.com/Nayoh9" target="blank">
          <motion.div
            ...
            viewport={{ once: true }}
            className=": flex h-contactBoxHeight w-80  flex-col items-center rounded-md  bg-lightGrey p-10 dark:border-white dark:bg-gray-900 max-[1125px]:w-contactBoxWidth max-[600px]:w-80"
          >
            <p className="mb-7 text-lg font-semibold dark:text-white">
              Follow me on Github
            </p>
        ...
        <a href="mailto: y.andre90000@gmail.com">
          <motion.div
            ...
            viewport={{ once: true }}
            className=" flex h-contactBoxHeight w-80 flex-col items-center rounded-md border-2 border-gmailColor bg-lightGrey p-10 dark:bg-gray-900 max-[1125px]:w-contactBoxWidth max-[600px]:w-80 "
          >
            <p className="mb-7  text-lg font-semibold dark:text-white">
              Send me an email
            </p>
