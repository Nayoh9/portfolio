...
const Home = () => {
  ...
  return (
    <section
      ...
      className="mb-28 flex h-4/6 flex-col font-mont text-white"
    >
      <img
        className="absolute top-0 z-0 h-4/6 w-full  animate-fadeAnim object-cover"
        src="https://res.cloudinary.com/dwkwlok28/image/upload/v1704811696/portfolio/cloud-background_idlorr.jpg"
      />
      <div className=" z-00 absolute top-0 h-4/6  w-full animate-fadeAnim bg-black opacity-65"></div>
      <header className="relative  flex h-20 w-full animate-fadeHeader items-center justify-between px-32">
      ...
      <div className="absolute top-40 animate-fadeHeader ">
        <div
